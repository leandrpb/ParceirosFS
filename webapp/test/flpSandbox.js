		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Parceiros",
									"targetURL": "#zappfreestyleparceiros-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zappfreestyleparceiros-display": {
								"semanticObject": "zappfreestyleparceiros",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zappfreestyle.parceiros",
									"url": sap.ui.require.toUrl("zappfreestyle/parceiros")
								}
							}
						}
					}
